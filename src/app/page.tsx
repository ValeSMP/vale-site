      ...
      <div className="absolute bottom-0 left-0 right-0 h-2 bg-gradient-to-b from-transparent to-[#0d1117] z-[1]" />      
        ...
        <div className=" container relative mx-auto px-4 py-24">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-8 text-xl text-muted-foreground font-ranyth-mixed">
            ...
            <div className="flex justify-center">
              <Link href="https://discord.gg/ut7KJgANkY" target="_blank" rel="noopener noreferrer">
                <Button 
                  size="lg" 
                  className="bg-vale-blue-light hover:bg-vale-blue-light/90 transition-all duration-200 hover:scale-105 px-10 py-7 text-xl font-ranyth-mixed font-bold tracking-wide shadow-lg"
                >
        ...
        <div className="container mx-auto max-w-6xl px-4">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Card className="overflow-hidden border-0 bg-[#161b22]">
              ...
              <div className="p-4">
                <h3 className="font-semibold">Spawn Area</h3>
            ...
            <Card className="overflow-hidden border-0 bg-[#161b22]">
              ...
              <div className="p-4">
                <h3 className="font-semibold">Shopping District</h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8">
            ...
            <div className="col-span-2">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-xl font-bold">ValeSMP</span>
              </div>
